...
-- Segment bookings table - links journeys to segments
...
-- Create index for efficient segment booking queries
CREATE INDEX segment_bookings_segment_id_idx ON segment_bookings(segment_id);
CREATE INDEX segment_bookings_journey_idx ON segment_bookings(booking_id);
